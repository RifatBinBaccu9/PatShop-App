      ...
      <div className="lg:flex lg:gap-x-10 w-10/12 md:w-[70%] mx-auto">
        <div className="w-11/12 mx-auto sm:mx-0 sm:w-2/3 lg:w-[30%] mb-10 lg:mb-0">
          <div className='flex gap-x-2 mb-8 lg:mb-16'>
            ...
            <h1 className="text-3xl lg:text-2xl font-bold text-[#FF6F3F] fontLaila ">PetStick</h1>
          </div>

          <p className=" text-center  sm:text-start text-lg lg:text-base fontLora font-normal mb-5">At petstick, we offer quality products and services to keep your pet healthy and happy, with expert care from our dedicated team.</p>
